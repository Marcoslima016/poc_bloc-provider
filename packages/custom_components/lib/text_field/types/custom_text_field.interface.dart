...
abstract class ICustomTextField extends StatelessWidget {
    ...
    return Container(
      ...
      child: Theme(
        ...
        data: Theme.of(context).copyWith(
          // primaryColor: preferences.focusedIconsColor,
        ...
        child: TextFormField(
          ...
          scrollPadding: EdgeInsets.only(bottom: preferences.keyboardPadding),
          style: TextStyle(
  ...
  get setInputDecoration {
    ...
    preferences.inputDecoration = InputDecoration(
      ...
      suffixIcon: haveLeftIcon ? preferences.leftIcon : null,
      //
